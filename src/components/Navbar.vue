...
<template>
  ...
  <div class="relative bg-white">
        ...
        <nav class="flex space-x-10">
          <div class="relative">
            ...
            <button
              ...
              @click="toggleMenuOne = !toggleMenuOne"
            >
              <span>Solutions</span>
            ...
            >
              <div class="absolute -ml-4 mt-3 transform w-screen max-w-md lg:max-w-3xl" v-show="toggleMenuOne">
          ...
          <div class="relative">
            ...
            <button
              type="button"
              class="group text-gray-500 inline-flex items-center space-x-2 text-base leading-6 font-medium hover:text-gray-900 focus:outline-none focus:text-gray-900 transition ease-in-out duration-150"
              @click="toggleMenuTwo = !toggleMenuTwo"
            >
              <span>More</span>
              <!-- Item active: "text-gray-600", Item inactive: "text-gray-400" -->
              <svg
            ...
            <transition
              ...
              leave-to-class="opacity-0 translate-y-1"
            >
              <div class="absolute left-1/2 transform -translate-x-1/2 mt-3 px-2 w-screen max-w-xs sm:px-0" v-show="toggleMenuTwo">
                <div class="rounded-lg shadow-lg">
                  <div class="rounded-lg shadow-xs overflow-hidden">
    ...
    <transition
      ...
      leave-to-class="opacity-0 translate-y-1"
    >
      <div class="absolute top-0 inset-x-0 p-2 transition transform origin-top-right md:hidden" v-show="toggleMobileMenu">
        <div class="rounded-lg shadow-lg">
